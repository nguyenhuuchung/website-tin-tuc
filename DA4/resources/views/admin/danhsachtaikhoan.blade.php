...
<head>
    ...
    <title>Admin Tin Tức Giáo Dục</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Admin Tin Tức Giáo Dục</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('dslt')}}">Danh sách loại tin</a>
                                </li>
                                <li>
                                    <a href="{{route('tlt')}}">Thêm loại tin</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('dstt')}}">Danh sách tin tức</a>
                                </li>
                                <li>
                                    <a href="{{route('ttt')}}">Thêm tin tức</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{route('dstk')}}">Danh sách tài khoản</a>
                                </li>
                                <li>
                                    <a href="{{route('ttk')}}">Thêm tài khoản</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            <tr class="odd gradeX" align="center">
                                ...
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="#">Biên tập</a></td>
                            </tr>
