            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="{{route('sttt')}}" method="POST" enctype="multipart/form-data" id="theform">
                            @csrf
                            <div class="form-group">
                                <label>Tên tin</label>
                                <input type="text" class="form-control" name="tentin" id="tentin" />
                            </div>
                            <div class="form-group">
                                <label>Tiêu đề</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <textarea class='ckeditor' required  name="noidung" id="name" cols="70" rows="10"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <img style="width: 250px;height: 220px;" id="blah">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Ngày đăng</label>
                                <input type="date" class="form-control" name="ngaydang" id="ngaydang" />
                            </div>
                            <div class="form-group">
